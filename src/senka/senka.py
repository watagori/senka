...
class Senka:
    ...
    def get_caaj_csv(self, chain: str, address: str, starttime: int = None, endtime: int = None) -> str:
        caaj_list, unknown_transactions_list = self.get_caaj(chain, address, starttime=starttime, endtime=endtime)
    ...
    def get_caaj(
        self, chain: str, address: str, starttime: int = None, endtime: int = None
        ...
        transactions = transaction_generator.get_transactions(self.setting, address, starttime=starttime, endtime=endtime)
